...
public class HomePage extends JFrame {
    ...
    public HomePage(){
        ...
        register=new JPanel();
        reserve=new JPanel();
        logo=new JLabel(new ImageIcon(("/Users/Shared/Files From d.localized/ASU CESS/Sophomore Level/" +
                "Software Engineering (1)/Faculty_Registeration_System/1.jpg")));
        buttonsPnl=new JPanel();
        addIcon=new JLabel(new ImageIcon(("/Users/Shared/Files From d.localized/ASU CESS/Sophomore Level" +
                "/Software Engineering (1)/Faculty_Registeration_System/Main Icons/add.png")));
        userIcon=new JLabel(new ImageIcon(("/Users/Shared/Files From d.localized/ASU CESS/Sophomore Level/" +
                "Software Engineering (1)/Faculty_Registeration_System/Main Icons/user.png")));
        reserveIcon=new JLabel(new ImageIcon(("/Users/Shared/Files From d.localized/ASU CESS/Sophomore Level/" +
                "Software Engineering (1)/Faculty_Registeration_System/Main Icons/reserve.png")));
        courseIcon=new JLabel(new ImageIcon(("/Users/Shared/Files From d.localized/ASU CESS/Sophomore Level/" +
                "Software Engineering (1)/Faculty_Registeration_System/Main Icons/course.png")));
